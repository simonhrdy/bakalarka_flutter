...
(bool, Future<DataState<void>> Function(SeasonParams)) useSeasonMutation() {
  final isLoading = useState(false);
  final repository = useInjector<ApiRepository>();

  Future<DataState<void>> create(SeasonParams params) async {
    isLoading.value = true;
    final result = await repository.createSeason(params);
